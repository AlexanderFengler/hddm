...
class Config(object):
    ...
    def __init__(self, model=None, bins=None, N=None):
        ...
        self.method_options = {'ddm': self.ddm_initialize, 'angle': self.angle_initialize, 'weibull_cdf': self.weibull_initialize, 'weibull': self.weibull_initialize, 'ornstein': self.ornstein_initialize,
